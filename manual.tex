...
\htmladdnormallink{Example 5}{https://krdwrd.org/pages/bin/view/436}

\htmladdnormallink{Example 6}{https://krdwrd.org/pages/bin/view/437}

% kann man nicht so markieren wie man will
\htmladdnormallink{Example 7}{https://krdwrd.org/pages/bin/view/438}

% einfacher erst gruen dann rot zu markieren
\htmladdnormallink{Example 8}{https://krdwrd.org/pages/bin/view/439}

% man kann nur ganz oder garnicht markieren. resultat immer suboptimal
\htmladdnormallink{Example 9}{https://krdwrd.org/pages/bin/view/440}


\subsection{Examples - Hard}
% 
\htmladdnormallink{Example 10}{https://krdwrd.org/pages/bin/view/441}

% braindamage
\htmladdnormallink{Example 12}{https://krdwrd.org/pages/bin/view/442}
